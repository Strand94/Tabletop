...
export const nb = {
  ...
  navSub: {
    dashboard: 'Oversikt over samlingen',
    collection: 'Spill og ønskeliste',
    sessions: 'Loggede partier',
    players: 'Spillere i husstanden',
    browseBgg: 'Importer fra BoardGameGeek',
    settings: 'Innstillinger',
  },
  shelfOfShame: {
